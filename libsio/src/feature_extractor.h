...
class FeatureExtractor {
    ...
    // need pointer here to support multiple types of extractor_s (e.g. fbank, mfcc)
...
public:
    Error Load(const FeatureExtractorConfig& config, Optional<const MeanVarNorm*> mvn = nullptr) { 
